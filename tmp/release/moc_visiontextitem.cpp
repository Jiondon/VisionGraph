...
QT_MOC_LITERAL(5, 53, 20), // "signal_DoubleClicked"
QT_MOC_LITERAL(6, 74, 13) // "signalChanged"

    },
    "VisionTextItem\0signal_RightClicked\0\0"
    "VisionItem*\0item\0signal_DoubleClicked\0"
    "signalChanged"
};
...
void VisionTextItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_RightClicked((*reinterpret_cast< VisionItem*(*)>(_a[1]))); break;
        case 1: _t->signal_DoubleClicked((*reinterpret_cast< VisionItem*(*)>(_a[1]))); break;
        ...
        {
            typedef void (VisionTextItem::*_t)(VisionItem * );
        ...
        {
            typedef void (VisionTextItem::*_t)(VisionItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VisionTextItem::signalChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void VisionTextItem::signal_RightClicked(VisionItem * _t1)
{
...
// SIGNAL 1
void VisionTextItem::signal_DoubleClicked(VisionItem * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void VisionTextItem::signalChanged(VisionItem * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

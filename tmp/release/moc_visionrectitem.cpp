...
QT_MOC_LITERAL(4, 53, 11), // "VisionItem*"
QT_MOC_LITERAL(5, 65, 4), // "item"
QT_MOC_LITERAL(6, 70, 9), // "slotIndex"
QT_MOC_LITERAL(7, 80, 5), // "index"
QT_MOC_LITERAL(8, 86, 14), // "slotArrowsItem"
QT_MOC_LITERAL(9, 101, 20) // "slotArrowsItem_leave"

    },
    "VisionRectItem\0signal_RectSizeChanged\0"
    "\0signalChanged\0VisionItem*\0item\0"
    "slotIndex\0index\0slotArrowsItem\0"
...
void VisionRectItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalChanged((*reinterpret_cast< VisionItem*(*)>(_a[1]))); break;
        case 2: _t->slotIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->slotArrowsItem(); break;
        case 4: _t->slotArrowsItem_leave(); break;
        default: ;
        }
        ...
        {
            typedef void (VisionRectItem::*_t)(VisionItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VisionRectItem::signalChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void VisionRectItem::signalChanged(VisionItem * _t1)
{
